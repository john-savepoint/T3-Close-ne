    ...
    <div className="container mx-auto space-y-8 py-8">
      <div className="space-y-4 text-center">
        ...
        <p className="mx-auto max-w-2xl text-muted-foreground">
          Test the complete resumable streams implementation with Redis persistence, multi-device
          access, and background generation.
        </p>
      </div>
          ...
          <div className="space-y-4">
            ...
            {redisTest && (
              <div className="space-y-2">
                ...
                {redisTest.error && (
                  <div className="text-sm text-destructive">Error: {redisTest.error}</div>
                )}
      ...
      <Card>
        ...
        <CardContent className="space-y-4 text-sm">
          <div>
            <h4 className="mb-2 font-semibold">1. Test Basic Streaming:</h4>
          ...
          <div>
            <h4 className="mb-2 font-semibold">2. Test Resumability:</h4>
            <ul className="list-inside list-disc space-y-1 text-muted-foreground">
          ...
          <div>
            <h4 className="mb-2 font-semibold">3. Test Multi-Device Access:</h4>
            <ul className="list-inside list-disc space-y-1 text-muted-foreground">
          ...
          <div>
            <h4 className="mb-2 font-semibold">4. Test Background Generation:</h4>
            <ul className="list-inside list-disc space-y-1 text-muted-foreground">
