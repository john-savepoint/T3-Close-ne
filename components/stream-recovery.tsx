    ...
    <div className={`space-y-6 ${className}`}>
          ...
          <CardContent>
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                ...
                <code className="text-xs bg-muted px-2 py-1 rounded">{sessionInfo.id}</code>
              </div>
      ...
      <Card>
        ...
        <CardContent className="text-sm text-muted-foreground space-y-2">
          <p>
            • <strong>Survives interruptions:</strong> Streams continue even if you close the tab or lose connection
          </p>
          <p>
            • <strong>Multi-device access:</strong> Use the session ID to view the same stream on different devices
          </p>
          <p>
            • <strong>Automatic recovery:</strong> The system automatically reconnects and resumes from where it left off
          </p>
          <p>
            • <strong>Background generation:</strong> LLM responses are generated server-side and persist in Redis
          </p>
        </CardContent>
      </Card>
    </div>
